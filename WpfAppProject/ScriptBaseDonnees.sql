...
INSERT INTO "Customers" VALUES('ANATR', 'Ana Trujillo Emparedados y helados', 	'Ana Trujillo', 	'Owner', 	'Avda. de la Constitución 2222', 	NULL, 	'05021', 	'Mexico', 	'(5) 555-4729', 	'(5) 555-3745')	;
INSERT INTO "Customers" VALUES('ANTON', 'Antonio Moreno Taquería', 	'Antonio Moreno', 	'Owner', 	'Mataderos  2312', 	NULL, 	'05023', 	'Mexico', 	'(5) 555-3932', 	NULL)	;
...
INSERT INTO "Customers" VALUES('BERGS', 'Berglunds snabbköp', 	'Christina Berglund', 	'Order Administrator', 	'Berguvsvägen  8', 	NULL, 	'S-958 22', 	'Sweden', 	'0921-12 34 65', 	'0921-12 34 67')	;
...
INSERT INTO "Customers" VALUES('COMMI', 'Comércio Mineiro', 	'Pedro Afonso', 	'Sales Associate', 	'Av. dos Lusíadas', 	'Sao Paulo', 	'SP', 	'05432-043', 'Brazil', '(11) 555-7647');
...
INSERT INTO "Customers" VALUES('FOLKO', 'Folk och fä HB', 	'Maria Larsson', 	'Owner', 	'Åkergatan 24', 	NULL, 	'S-844 67', 	'Sweden', 	'0695-34 67 21', 	NULL);
...
INSERT INTO "Customers" VALUES('KOENE', 'Königlich Essen', 	'Philip Cramer', 	'Sales Associate', 	'Maubelstr. 90', 	NULL, 	'14776', 	'Germany', 	'0555-09876', 	NULL);
...
INSERT INTO "Customers" VALUES('LILAS', 'LILA-Supermercado', 	'Carlos González', 	'Accounting Manager', 	'Carrera 52 con Ave. Bolívar #65-98 Llano Largo', 	'Lara', 	'3508', 	'Venezuela', 	'(9) 331-6954', 	'(9) 331-7256');
...
INSERT INTO "Customers" VALUES('MEREP', 'Mère Paillarde', 	'Jean Fresnière', 	'Marketing Assistant', 	'43 rue St. Laurent', 	'Québec', 	'H1J 1C3', 	'Canada', 	'(514) 555-8054', 	'(514) 555-8055');
...
INSERT INTO "Customers" VALUES('OCEAN', 'Océano Atlántico Ltda.', 	'Yvonne Moncada', 	'Sales Agent', 	'Ing. Gustavo Moncada 8585 Piso 20-A', 	NULL, 	'1010', 	'Argentina', 	'(1) 135-5333', 	'(1) 135-5535');
...
INSERT INTO "Customers" VALUES('OTTIK', 'Ottilies Käseladen', 	'Henriette Pfalzheim', 	'Owner', 	'Mehrheimerstr. 369', 	NULL, 	'50739', 	'Germany', 	'0221-0644327', 	'0221-0765721');
INSERT INTO "Customers" VALUES('PARIS', 'Paris spécialités', 	'Marie Bertrand', 	'Owner', 	'265', 	'Paris',  	'75012', 	'France', 	'42.34.22.66',	'42.34.22.77');
INSERT INTO "Customers" VALUES('PERIC', 'Pericles Comidas clásicas', 	'Guillermo Fernández', 	'Sales Representative', 	'Calle Dr. Jorge Cash 321', 	NULL, 	'05033', 	'Mexico', 	'(5) 552-3745', '545-3745');
...
INSERT INTO "Customers" VALUES('PRINI', 'Princesa Isabel Vinhos', 	'Isabel de Castro', 	'Sales Representative', 'Estrada da saúde n. 58', 	NULL, 	'1756', 	'Portugal', 	'(1) 356-5634', 	NULL)	
INSERT INTO "Customers" VALUES('QUICK', 'QUICK-Stops', 	'Horst Kloss', 	'Accounting Manager', 	'Taucherstraße 10', 	NULL, 	'01307', 	'Germany', 	'0372-035188', 	NULL);	
INSERT INTO "Customers" VALUES('RANCH', 'Rancho grande', 	'Sergio Gutiérrez', 'Sales Representative', 	'Av. del Libertador 900', 	NULL, 	'1010', 	'Argentina', 	'(1) 123-5555', 	'(1) 123-5556');
...
INSERT INTO "Customers" VALUES('SANTG', 'Santé Gourmet', 'Jonas Bergulfsen', 'Owner', 	'Erling Skakkes gate 78', 	NULL, 	'4110', 	'Norway', 	'07-98 92 35', 	'07-98 92 47');
...
INSERT INTO "Customers" VALUES('SIMOB', 'Simons bistro', 	'Jytte Petersen', 	'Owner', 	'Vinbæltet 34', 	NULL, 	'1734', 	'Denmark', 	'31 12 34 56', 	'31 13 35 57');	
INSERT INTO "Customers" VALUES('SPECD', 'Spécialités du monde', 'Dominique Perrier', 	'Marketing Manager', 	'25', 	'Paris', 	'75016', 	'France', 	'47.55.60.10',	'47.55.60.20');
...
INSERT INTO "Customers" VALUES('SUPRD', 'Suprêmes délices', 	'Pascale Cartrain', 	'Accounting Manager', 	'Boulevard Tirou', 	'Charleroi', 	'B-6000', 	'Belgium', 	' 23 67 22 20',	'23 67 22 21');
...
INSERT INTO "Customers" VALUES('TOMSP', 'Toms Spezialitäten',	'Karin Josephs', 	'Marketing Manager', 	'Luisenstr. 48', 	NULL, 	'44087', 	'Germany', 	'0251-031259', 	'0251-035695');
...
INSERT INTO "Customers" VALUES('TRADH', 'Tradição Hipermercados', 'Anabela Domingues', 	'Sales RepreOriginative', 	'Av. Inês de Castro', 	'SP', 	'05634-030', 	'Brazil', 	'(11) 555-2167','(11) 555-2168');
...
INSERT INTO "Customers" VALUES('WANDK', 'Die Wandernde Kuh', 	'Rita Müller', 	'Sales Representative', 	'Adenauerallee 900', 	 null,	'70563', 	'Germany', 	'0711-020361', 	'0711-035428');	
...
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued") 	VALUES(22	,'Gustaf''s Knäckebröd' , 	5 , 	'24 - 500 g pkgs.',	21,	104,	0,	0);
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(23	,'Tunnbröd' , 	5 , 	'12 - 250 g pkgs.',	9,	61,	0,	0);
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(24	,'Guaraná Fantástica' , 	1 , 	'12 - 355 ml cans',	4.5,	20,	0,	1);
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued") 	VALUES(25	,'NuNuCa Nuß-Nougat-Creme' , 	3 , 	'20 - 450 g glasses',	14,	76,	0,	0);
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(26	,'Gumbär Gummibärchen' , 	3 , 	'100 - 250 g bags',	31.23,	15,	0,	0);
...
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued") 	VALUES(28	,'Rössle Sauerkraut' , 	7 , 	'25 - 825 g cans',	45.6,	26,	0,	1);
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(29	,'Thüringer Rostbratwurst' , 	6 , 	'50 bags x 30 sausgs.',	123.79,	0,	0,	1);
...
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(54	,'Tourtière' , 	6 , 	'16 pies',	7.45,	21,	0,	0);
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued") 	VALUES(55	,'Pâté chinois' , 	6 , 	'24 boxes x 2 pies',	24,	115,	0,	0);
...
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued") 	VALUES(61	,'Sirop d''érable' , 	2 , 	'24 - 500 ml bottles',	28.5,	113,	0,	0);
...
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(64	,'Wimmers gute Semmelknödel' , 	5 , 	'20 bags x 4 pieces',	33.25,	22,	80,	0);
...
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(73	,'Röd Kaviar' , 	8 , 	'24 - 150 g jars',	15,	101,	0,	0);
...
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(75	,'Rhönbräu Klosterbier' , 	1 , 	'24 - 0.5 l bottles',	7.75,	125,	0,	0);
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")VALUES(76	,'Lakkalikööri' , 	1 , 	'500 ml',	18,	57,	0,	0);
INSERT INTO "Products"("ProductID","ProductName","CategoryID","QuantityPerUnit","UnitPrice","UnitsInStock","UnitsPerOrder","Discontinued")	VALUES(77	,'Original Frankfurter grüne Soße' , 	2 , 	'12 boxes',	13,	32,	0,	0);
